...
#Talk to & execute commands on a remote host Unix device
...
def send_text_2_file(ip,user_n,pass_w,in_text):
	...
	try:
		...
		SSH_remote.connect(ip, username=user_n, password=pass_w, look_for_keys=False, allow_agent=False)
		#open a shell
...
def set_pi_date_time(ip,user_n,pass_w):
	...
	try:
		...
		d_date = dt_str[10:12].replace(' ','0') + " " + dt_str[6:9].upper() + " " + dt_str[26:30] + " " + dt_str[13:21]
		print(dt_str)
		print(d_date)

		#break 		#uncomment to set local time ona Raspberry Pi or unix device
...
if __name__ == '__main__':
	...
	send_text_2_file(SSH_login_demo.my_ip, SSH_login_demo.my_user_id,SSH_login_demo.my_password,"Hello World!")
	set_pi_date_time(SSH_login_demo.my_ip, SSH_login_demo.my_user_id,SSH_login_demo.my_password)	