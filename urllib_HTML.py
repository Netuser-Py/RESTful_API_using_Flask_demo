...
def main():
    print("hello there. this is a demo of how to use urllib.request.urlopen to get website data.")  
    ...
    flask_REST_code_URL = r"https://blog.miguelgrinberg.com/post/designing-a-restful-api-with-python-and-flask"
    py_north_logo1_URL = r"https://secure.meetupstatic.com/photos/event/9/2/7/8/global_434497496.jpeg"
    py_north_logo2_URL = r"https://secure.meetupstatic.com/photos/theme_head/1/3/3/d/full_6724925.jpeg"
